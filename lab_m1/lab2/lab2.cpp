...
void Lab2::Init()
{
    ...
    // Create a mesh box using custom data
    {
        ...
        {
            VertexFormat(glm::vec3(-1, -1,  1), glm::vec3(0.145, 0.588, 0.745), glm::vec3(0.2, 0.8, 0.6)),
    ...
    // by definition!
    {
        vector<VertexFormat> vertices2
        {
            ...
            VertexFormat(glm::vec3(-1,  1,  1), glm::vec3(0.145, 0.588, 0.745), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3( 1,  1,  1), glm::vec3(0.145, 0.588, 0.745), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3( 1,  1, -1), glm::vec3(1, 0.588, 0.745), glm::vec3(0.2, 0.8, 0.6)),

            VertexFormat(glm::vec3(1, -1,  1), glm::vec3(0.145, 0, 0.745), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(-1,  1,  1), glm::vec3(1, 0.588, 0.745), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1,  1,  1), glm::vec3(1, 0.588, 0.745), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1,  1, -1), glm::vec3(0.145, 0, 0.745), glm::vec3(0.2, 0.8, 0.6)),

            VertexFormat(glm::vec3(1, -1,  1), glm::vec3(0, 0.588, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(-1,  1,  1), glm::vec3(0, 0.588, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1,  1,  1), glm::vec3(0.145, 0, 0.745), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1,  1, -1), glm::vec3(0, 0.588, 0), glm::vec3(0.2, 0.8, 0.6)),            
        ...
        // Actually create the mesh from the data
        CreateMesh("tetra", vertices2, indices2);
    }
    ...
    // opposing vertex orientations.
    {
        vector<VertexFormat> vertices3
        {
            ...
            VertexFormat(glm::vec3(2, 0, 0), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2, 1, 0), glm::vec3(1, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(0.5, 0, 1), glm::vec3(0.2, 0.8, 0.6)),

            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.5, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(2, 1, 0), glm::vec3(0.5, 0, 1), glm::vec3(0.2, 0.8, 0.6)),
        ...
        // Actually create the mesh from the data
        CreateMesh("square", vertices3, indices3);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(3, 0.5f, 0), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetra"], shaders["VertexColor"], glm::vec3(2, 1, 0), glm::vec3(0.25f));
